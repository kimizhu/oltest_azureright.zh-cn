...
|**一般性保护**|如果选择此选项，则意味着无法本机保护所选文件。有关详细信息，请参阅本主题中的[What’s the difference between generic protection and built-in (native) protection?](../Topic/Dialog_box_options_for_the_Rights_Management_sharing_application.md#BKMK_GenericNative)。|
